...
fun MyPostsScreen() {
    ...
    LaunchedEffect(context.route) {
        postsToSkip = 0
        if (hasParams) {
            (document.getElementById(ResourceConstants.CSSIds.adminSearchBar) as HTMLInputElement).value = query.replace("%20", " ")
            searchPostsByTitle(
                query = query,
                skip = postsToSkip,
                onSuccess = {
        ...
        Column(
            ...
            Box(
                ...
                SearchBar(
                    ...
                    onEnterClick = {
                        val searchInput =
                            (document.getElementById(ResourceConstants.CSSIds.adminSearchBar) as HTMLInputElement).value
